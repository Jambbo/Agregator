...
private final String URL_FORMAT = "https://career.habr.com/vacancies?q=java+%s&page=%d";
    @Override
        ...
        try{
            do{
                ...
                for(Element e:vacanciesHtmlList){
                    ...
                    Elements locations = e.getElementsByClass("location");
                    Elements companyName = e.getElementsByClass("companyName");
                    Elements salary = e.getElementsByClass("count");
